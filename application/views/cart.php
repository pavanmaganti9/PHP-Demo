...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            <div class="container">
              <a class="navbar-brand" href="<?php echo base_url();?>">Plastic Products</a>
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                ...
                <a class="dropdown-item" href="checkout.html">Checkout</a>
                  ...
                  <li class="nav-item cta cta-colored"><a href="cart.html" class="nav-link"><span class="icon-shopping_cart"></span>[<?php echo $this->cart->total_items(); ?>]</a></li>
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('<?php echo base_url(); ?>assets/front/images/bg_2.jpg');">
      <div class="container">
                                        ...
                                        <table class="table">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr class="text-center">
                                                        ...
                                                        <td class="image-prod"><div class="img" style="background-image:url(<?php echo site_url('assets/images/products/'.$items['image']); ?>);"></div></td>
